...
SOURCE_PATH = "/Volumes/delivery_analytics/bronze/raw_landing/raw_source/shifts/"
TARGET_TABLE = "delivery_analytics.bronze.shifts_raw"
...
schema = StructType([
    ...
    StructField("shift_start_ts", TimestampType()),
    StructField("shift_end_ts", TimestampType()),
    StructField("scheduled_hours", DoubleType()),
    StructField("actual_login_ts", TimestampType()),
    StructField("actual_logout_ts", TimestampType()),
    StructField("shift_status", StringType()),
    StructField("late_start_flag", BooleanType()),
    StructField("early_logout_flag", BooleanType()),
    StructField("overtime_flag", BooleanType()),
