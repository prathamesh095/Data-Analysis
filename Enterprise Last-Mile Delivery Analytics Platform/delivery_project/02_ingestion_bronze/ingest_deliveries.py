...
SOURCE_PATH = "/Volumes/delivery_analytics/bronze/raw_landing/raw_source/deliveries/"
TARGET_TABLE = "delivery_analytics.bronze.deliveries_raw"
...
schema = StructType([
    ...
    StructField("dispatch_ts", TimestampType()),
    StructField("arrival_at_pickup_ts", TimestampType()),
    StructField("pickup_ts", TimestampType()),
    StructField("departure_from_pickup_ts", TimestampType()),
    StructField("arrival_at_drop_ts", TimestampType()),
    StructField("drop_ts", TimestampType()),
    StructField("delivery_status", StringType()),
    StructField("failure_reason", StringType()),
    StructField("distance_km_actual", DoubleType()),
    StructField("duration_min_actual", IntegerType()),
    StructField("traffic_delay_min", IntegerType()),
    StructField("weather_flag", BooleanType()),
    StructField("proof_of_delivery_flag", BooleanType()),
    StructField("customer_rating", IntegerType()),
    StructField("rider_rating", IntegerType()),
