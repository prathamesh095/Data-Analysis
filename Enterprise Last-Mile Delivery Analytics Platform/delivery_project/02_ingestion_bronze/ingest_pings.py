...
SOURCE_PATH = "/Volumes/delivery_analytics/bronze/raw_landing/raw_source/pings/"
TARGET_TABLE = "delivery_analytics.bronze.pings_raw"
TRACKER_TABLE = "delivery_analytics.bronze.file_ingestion_tracker"

# COMMAND ----------

schema = StructType([
    StructField("ping_id", StringType()),
    ...
    StructField("accuracy_meters", IntegerType()),
    StructField("battery_level", IntegerType()),
    StructField("network_type", StringType()),
    StructField("ping_ts", TimestampType()),
    StructField("gps_provider", StringType()),
    StructField("is_mock_location_flag", BooleanType()),
