...
SOURCE_PATH = "/Volumes/delivery_analytics/bronze/raw_landing/raw_source/riders/"
TARGET_TABLE = "delivery_analytics.bronze.riders_raw"
...
schema = StructType([
    ...
    StructField("home_zone", StringType()),
    StructField("join_date", TimestampType()),
    StructField("vehicle_type", StringType()),
    StructField("license_verified_flag", BooleanType()),
    StructField("background_check_flag", BooleanType()),
    StructField("employment_type", StringType()),
    StructField("status", StringType()),
    StructField("rating_avg", DoubleType()),
    StructField("total_deliveries_lifetime", IntegerType()),
    StructField("last_active_ts", TimestampType()),
    StructField("device_os", StringType()),
    StructField("device_model", StringType()),
    StructField("bank_account_verified", BooleanType()),
    StructField("incentive_tier", StringType()),
