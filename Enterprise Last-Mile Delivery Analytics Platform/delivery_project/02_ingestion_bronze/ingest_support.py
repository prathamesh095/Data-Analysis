...
SOURCE_PATH = "/Volumes/delivery_analytics/bronze/raw_landing/raw_source/support/"
TARGET_TABLE = "delivery_analytics.bronze.support_raw"
...
schema = StructType([
    ...
    StructField("issue_category", StringType()),
    StructField("issue_subcategory", StringType()),
    StructField("priority_level", StringType()),
    StructField("ticket_channel", StringType()),
    StructField("agent_id", StringType()),
    StructField("resolution_status", StringType()),
    StructField("resolution_ts", TimestampType()),
    StructField("compensation_amount", DoubleType()),
    StructField("csat_score", IntegerType()),
    StructField("reopened_flag", BooleanType()),
    StructField("notes_text", StringType()),
